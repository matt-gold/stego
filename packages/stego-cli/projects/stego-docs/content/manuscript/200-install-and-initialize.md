...
The Stego VS Code extension is the official UI for Stego projects. It provides project-aware controls, checks, comments, metadata editing, and leaf explorer navigation while you edit.
