...
- `stego build --project <project-id> [--root <path>]`
- Compile project sources through `templates/book.template.tsx` into generated markdown output.
- Related workflows: FLOW-BUILD-EXPORT, FLOW-DAILY-WRITING.
- Related concepts: CON-MANUSCRIPT, CON-DIST, CON-TEMPLATE-ENGINE.
