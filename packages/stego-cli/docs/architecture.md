...
`@stego-labs/cli` now uses a domain-first module layout under `src/modules`.
...
- `@stego-labs/shared`: shared contracts and domain primitives published as a first-class package boundary
