export function buildPandocMetadata(layout) {
    const metadata = {};
...
function renderRegion(kind, region) {
    if (!region) {
        return [];
    }
    const lines = [];
    for (const [slot, value] of Object.entries(region)) {
        if (!value) {
            continue;
        }
...
//# sourceMappingURL=metadata-writer.js.map